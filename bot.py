...
async def transfer_ticket(interaction: discord.Interaction, user: discord.Member):
    ...
    embed = discord.Embed(
        ...
        description=f"This ticket has been transferred to {user.mention}.",
        color=discord.Color.blue()
    )
...
async def add_mm(interaction: discord.Interaction, user: discord.Member):
    ...
    embed = discord.Embed(
        title="✅ Role Assigned",
        description=f"{user.mention} has been given a new role!",
        color=discord.Color.green()
    )
    embed.add_field(name="User", value=user.mention, inline=True)
    embed.add_field(name="Role", value=mm_role.mention, inline=True)
...
async def remove_mm(interaction: discord.Interaction, user: discord.Member):
    ...
    embed = discord.Embed(
        title="❌ Role Removed",
        description=f"{user.mention} has had a role removed.",
        color=discord.Color.red()
    )
    embed.add_field(name="User", value=user.mention, inline=True)
    embed.add_field(name="Role", value=mm_role.mention, inline=True)
...
async def add_hmm(interaction: discord.Interaction, user: discord.Member):
    ...
    embed.add_field(name="User", value=user.mention, inline=True)
    embed.add_field(name="Role", value=hmm_role.mention, inline=True)
    embed.add_field(name="Given By", value=interaction.user.mention, inline=True)
    embed.set_thumbnail(url=user.display_avatar.url if user.display_avatar else None)
    timestamp = int(datetime.utcnow().timestamp())
    embed.add_field(name="Date & Time", value=f"<t:{timestamp}:f>", inline=False)
...
async def add_mg(interaction: discord.Interaction, user: discord.Member):
    ...
    embed.add_field(name="User", value=user.mention, inline=True)
    embed.add_field(name="Role", value=mg_role.mention, inline=True)
    embed.add_field(name="Given By", value=interaction.user.mention, inline=True)
    embed.set_thumbnail(url=user.display_avatar.url if user.display_avatar else None)
    timestamp = int(datetime.utcnow().timestamp())
    embed.add_field(name="Date & Time", value=f"<t:{timestamp}:f>", inline=False)
...
async def add_hmg(interaction: discord.Interaction, user: discord.Member):
    ...
    embed.add_field(name="User", value=user.mention, inline=True)
    embed.add_field(name="Role", value=hmg_role.mention, inline=True)
    embed.add_field(name="Given By", value=interaction.user.mention, inline=True)
    embed.set_thumbnail(url=user.display_avatar.url if user.display_avatar else None)
    timestamp = int(datetime.utcnow().timestamp())
    embed.add_field(name="Date & Time", value=f"<t:{timestamp}:f>", inline=False)
...
async def add_mod(interaction: discord.Interaction, user: discord.Member):
    ...
    embed.add_field(name="User", value=user.mention, inline=True)
    embed.add_field(name="Role", value=mod_role.mention, inline=True)
    embed.add_field(name="Given By", value=interaction.user.mention, inline=True)
    embed.set_thumbnail(url=user.display_avatar.url if user.display_avatar else None)
    timestamp = int(datetime.utcnow().timestamp())
    embed.add_field(name="Date & Time", value=f"<t:{timestamp}:f>", inline=False)
...
async def add_hmod(interaction: discord.Interaction, user: discord.Member):
    ...
    embed.add_field(name="User", value=user.mention, inline=True)
    embed.add_field(name="Role", value=hmod_role.mention, inline=True)
    embed.add_field(name="Given By", value=interaction.user.mention, inline=True)
    embed.set_thumbnail(url=user.display_avatar.url if user.display_avatar else None)
    timestamp = int(datetime.utcnow().timestamp())
    embed.add_field(name="Date & Time", value=f"<t:{timestamp}:f>", inline=False)
...
async def warn(interaction: discord.Interaction, user: discord.Member, reason: str):
    ...
    try:
        await user.send("You are warne�d in Trade Hub")
    except:
        pass
